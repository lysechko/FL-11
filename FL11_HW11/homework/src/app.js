...
function handlerBtnClick() {
  ...
  function handlerClickBtnCreate(listText, listItem, label) {
  ...
  function drop(e) {
    ...
    if (e.target.localName === 'li' || e.target.localName === 'span') {
      ...
      listItem.children[0].addEventListener('click', handlerClickCheckbox.bind(this, label, listItem.children[2]));
      listItem.children[2].addEventListener('click', handlerClickBtnCreate.bind(this, listText, listItem, label));
      listItem.children[3].addEventListener('click', handlerClickBtnDel.bind(this, listItem));
